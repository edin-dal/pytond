...
def q01():
    ...
    df_group_1 = df_group_1[['l_returnflag', 'l_linestatus', 'sum_qty', 'sum_base_price', 'sum_disc_price', 'sum_charge', 'avg_qty', 'avg_price', 'avg_disc', 'count_order']]
...
def q04():
    ...
    df_group_1 = df_group_1[['o_orderpriority', 'order_count']]
...
def q05():
    ...
    df_group_1 = df_group_1[['n_name', 'revenue']]
...
def q07():
    ...
    df_group_1 = df_group_1[['supp_nation', 'cust_nation', 'l_year', 'revenue']]
...
def q09():
    ...
    df_group_1 = df_group_1[['nation', 'o_year', 'sum_profit']]
...
def q12():
    ...
    df_group_1 = df_group_1[['l_shipmode', 'high_line_count', 'low_line_count']]
...
def q13():
    ...
    df_group_2 = df_group_2[['c_count', 'custdist']]
...
def q16():
    ...
    df_group_1 = df_group_1[['p_brand', 'p_type', 'p_size', 'supplier_cnt']]
...
def q18():
    ...
    df_group_2 = df_group_2[['c_name', 'c_custkey', 'o_orderkey', 'o_orderdate', 'o_totalprice', 'suml_quantity']]
...
def q20():
    ...
    df_merge_3 = df_merge_3[(df_merge_3.ps_availqty > 0.50 * df_merge_3.suml_quantity)]
...
def q21():
    ...
    df_group_1 = df_group_1[['s_name', 'numwait']]
...
def q22():
    ...
    df_group_1 = df_group_1[['cntrycode', 'numcust', 'totacctbal']]
